exports.ISO8601_FORMAT = "yyyy-MM-dd hh:mm:ss";
exports.ISO8601_WITH_TZ_OFFSET_FORMAT = "yyyy-MM-ddThh:mm:ssO";
exports.DATETIME_FORMAT = "dd MM yyyy hh:mm:ss";
exports.ABSOLUTETIME_FORMAT = "hh:mm:ss";

exports.asString = function(/*format,*/ date) {
    var format = exports.ISO8601_FORMAT;
    if (/*typeof(date) === "string"*/arguments.length === 2) {
        format = arguments[0];
        date = arguments[1];
    }
